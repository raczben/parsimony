...
#ifndef X_JTAG_SIM_VIRTEX6_H
#define X_JTAG_SIM_VIRTEX6_H
...
namespace CPrimitives {
	...
	class X_JTAG_SIM_VIRTEX6: public Primitive{
		...
		public: X_JTAG_SIM_VIRTEX6(
			const char * name,
			//Verilog Parameters:
			parameter_string_t PART_NAME, // Default: "LX75T"
			//Verilog Ports in definition order:
			NetFlow* TDO_A0_B, // net ID: TDO lsb: 0  msb: 0 OUTPUT
			NetFlow* TCK_A0_B, // net ID: TCK lsb: 0  msb: 0 INPUT
			NetFlow* TDI_A0_B, // net ID: TDI lsb: 0  msb: 0 INPUT
