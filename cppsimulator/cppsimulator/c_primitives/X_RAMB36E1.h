...
namespace CPrimitives {
	...
	class X_RAMB36E1: public Primitive{
		...
		NetFlow* ADDRARDADDR; // net ID: ADDRARDADDR lsb: 0  msb: 15 INPUT
		NetFlow* ADDRBWRADDR; // net ID: ADDRBWRADDR lsb: 0  msb: 15 INPUT
		...
		NetFlow* DIADI; // net ID: DIADI lsb: 0  msb: 31 INPUT
		NetFlow* DIBDI; // net ID: DIBDI lsb: 0  msb: 31 INPUT
		NetFlow* DIPADIP; // net ID: DIPADIP lsb: 0  msb: 3 INPUT
		NetFlow* DIPBDIP; // net ID: DIPBDIP lsb: 0  msb: 3 INPUT
		...
		NetFlow* WEBWE; // net ID: WEBWE lsb: 0  msb: 7 INPUT
		...
		X_RAMB36E1(
			...
			this->ADDRARDADDR = ADDRARDADDR; // net ID: ADDRARDADDR lsb: 0  msb: 15 INPUT
			this->ADDRBWRADDR = ADDRBWRADDR; // net ID: ADDRBWRADDR lsb: 0  msb: 15 INPUT
			...
			this->DIADI = DIADI; // net ID: DIADI lsb: 0  msb: 31 INPUT
			this->DIBDI = DIBDI; // net ID: DIBDI lsb: 0  msb: 31 INPUT
			this->DIPADIP = DIPADIP; // net ID: DIPADIP lsb: 0  msb: 3 INPUT
			this->DIPBDIP = DIPBDIP; // net ID: DIPBDIP lsb: 0  msb: 3 INPUT
			...
			this->WEBWE = WEBWE; // net ID: WEBWE lsb: 0  msb: 7 INPUT
