...
namespace CPrimitives {
	...
	class X_PPC405_ADV: public Primitive{
		...
		NetFlow* APUFCMLOADBYTEEN_A0_B; // net ID: APUFCMLOADBYTEEN lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* C405DBGWBIAR_A0_B; // net ID: C405DBGWBIAR lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* C405PLBDCUABUS_A0_B; // net ID: C405PLBDCUABUS lsb: 0  msb: 0 OUTPUT
		NetFlow* C405PLBDCUBE_A0_B; // net ID: C405PLBDCUBE lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* C405PLBDCUPRIORITY_A0_B; // net ID: C405PLBDCUPRIORITY lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* C405PLBDCUWRDBUS_A0_B; // net ID: C405PLBDCUWRDBUS lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* C405PLBICUABUS_A0_B; // net ID: C405PLBICUABUS lsb: 0  msb: 0 OUTPUT
		NetFlow* C405PLBICUCACHEABLE_A0_B; // net ID: C405PLBICUCACHEABLE lsb: 0  msb: 0 OUTPUT
		NetFlow* C405PLBICUPRIORITY_A0_B; // net ID: C405PLBICUPRIORITY lsb: 0  msb: 0 OUTPUT
		NetFlow* C405PLBICUREQUEST_A0_B; // net ID: C405PLBICUREQUEST lsb: 0  msb: 0 OUTPUT
		NetFlow* C405PLBICUSIZE_A0_B; // net ID: C405PLBICUSIZE lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* C405TRCEVENEXECUTIONSTATUS_A0_B; // net ID: C405TRCEVENEXECUTIONSTATUS lsb: 0  msb: 0 OUTPUT
		NetFlow* C405TRCODDEXECUTIONSTATUS_A0_B; // net ID: C405TRCODDEXECUTIONSTATUS lsb: 0  msb: 0 OUTPUT
		NetFlow* C405TRCTRACESTATUS_A0_B; // net ID: C405TRCTRACESTATUS lsb: 0  msb: 0 OUTPUT
		NetFlow* C405TRCTRIGGEREVENTOUT_A0_B; // net ID: C405TRCTRIGGEREVENTOUT lsb: 0  msb: 0 OUTPUT
		NetFlow* C405TRCTRIGGEREVENTTYPE_A0_B; // net ID: C405TRCTRIGGEREVENTTYPE lsb: 0  msb: 0 OUTPUT
		NetFlow* C405XXXMACHINECHECK_A0_B; // net ID: C405XXXMACHINECHECK lsb: 0  msb: 0 OUTPUT
		NetFlow* DCREMACABUS_A0_B; // net ID: DCREMACABUS lsb: 0  msb: 0 OUTPUT
		NetFlow* DCREMACCLK_A0_B; // net ID: DCREMACCLK lsb: 0  msb: 0 OUTPUT
		NetFlow* DCREMACDBUS_A0_B; // net ID: DCREMACDBUS lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* DSOCMBRAMABUS_A0_B; // net ID: DSOCMBRAMABUS lsb: 0  msb: 0 OUTPUT
		NetFlow* DSOCMBRAMBYTEWRITE_A0_B; // net ID: DSOCMBRAMBYTEWRITE lsb: 0  msb: 0 OUTPUT
		NetFlow* DSOCMBRAMEN_A0_B; // net ID: DSOCMBRAMEN lsb: 0  msb: 0 OUTPUT
		NetFlow* DSOCMBRAMWRDBUS_A0_B; // net ID: DSOCMBRAMWRDBUS lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* EXTDCRABUS_A0_B; // net ID: EXTDCRABUS lsb: 0  msb: 0 OUTPUT
		NetFlow* EXTDCRDBUSOUT_A0_B; // net ID: EXTDCRDBUSOUT lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* ISOCMBRAMRDABUS_A0_B; // net ID: ISOCMBRAMRDABUS lsb: 0  msb: 0 OUTPUT
		NetFlow* ISOCMBRAMWRABUS_A0_B; // net ID: ISOCMBRAMWRABUS lsb: 0  msb: 0 OUTPUT
		NetFlow* ISOCMBRAMWRDBUS_A0_B; // net ID: ISOCMBRAMWRDBUS lsb: 0  msb: 0 OUTPUT
		...
		public: X_PPC405_ADV(
			...
			this->APUFCMLOADBYTEEN_A0_B = APUFCMLOADBYTEEN_A0_B; // net ID: APUFCMLOADBYTEEN lsb: 0  msb: 0 OUTPUT
			...
			this->C405DBGWBIAR_A0_B = C405DBGWBIAR_A0_B; // net ID: C405DBGWBIAR lsb: 0  msb: 0 OUTPUT
			...
			this->C405PLBDCUABUS_A0_B = C405PLBDCUABUS_A0_B; // net ID: C405PLBDCUABUS lsb: 0  msb: 0 OUTPUT
			this->C405PLBDCUBE_A0_B = C405PLBDCUBE_A0_B; // net ID: C405PLBDCUBE lsb: 0  msb: 0 OUTPUT
			...
			this->C405PLBDCUPRIORITY_A0_B = C405PLBDCUPRIORITY_A0_B; // net ID: C405PLBDCUPRIORITY lsb: 0  msb: 0 OUTPUT
			...
			this->C405PLBDCUWRDBUS_A0_B = C405PLBDCUWRDBUS_A0_B; // net ID: C405PLBDCUWRDBUS lsb: 0  msb: 0 OUTPUT
			...
			this->C405PLBICUABUS_A0_B = C405PLBICUABUS_A0_B; // net ID: C405PLBICUABUS lsb: 0  msb: 0 OUTPUT
			this->C405PLBICUCACHEABLE_A0_B = C405PLBICUCACHEABLE_A0_B; // net ID: C405PLBICUCACHEABLE lsb: 0  msb: 0 OUTPUT
			this->C405PLBICUPRIORITY_A0_B = C405PLBICUPRIORITY_A0_B; // net ID: C405PLBICUPRIORITY lsb: 0  msb: 0 OUTPUT
			this->C405PLBICUREQUEST_A0_B = C405PLBICUREQUEST_A0_B; // net ID: C405PLBICUREQUEST lsb: 0  msb: 0 OUTPUT
			this->C405PLBICUSIZE_A0_B = C405PLBICUSIZE_A0_B; // net ID: C405PLBICUSIZE lsb: 0  msb: 0 OUTPUT
			...
			this->C405TRCEVENEXECUTIONSTATUS_A0_B = C405TRCEVENEXECUTIONSTATUS_A0_B; // net ID: C405TRCEVENEXECUTIONSTATUS lsb: 0  msb: 0 OUTPUT
			this->C405TRCODDEXECUTIONSTATUS_A0_B = C405TRCODDEXECUTIONSTATUS_A0_B; // net ID: C405TRCODDEXECUTIONSTATUS lsb: 0  msb: 0 OUTPUT
			this->C405TRCTRACESTATUS_A0_B = C405TRCTRACESTATUS_A0_B; // net ID: C405TRCTRACESTATUS lsb: 0  msb: 0 OUTPUT
			this->C405TRCTRIGGEREVENTOUT_A0_B = C405TRCTRIGGEREVENTOUT_A0_B; // net ID: C405TRCTRIGGEREVENTOUT lsb: 0  msb: 0 OUTPUT
			this->C405TRCTRIGGEREVENTTYPE_A0_B = C405TRCTRIGGEREVENTTYPE_A0_B; // net ID: C405TRCTRIGGEREVENTTYPE lsb: 0  msb: 0 OUTPUT
			this->C405XXXMACHINECHECK_A0_B = C405XXXMACHINECHECK_A0_B; // net ID: C405XXXMACHINECHECK lsb: 0  msb: 0 OUTPUT
			this->DCREMACABUS_A0_B = DCREMACABUS_A0_B; // net ID: DCREMACABUS lsb: 0  msb: 0 OUTPUT
			this->DCREMACCLK_A0_B = DCREMACCLK_A0_B; // net ID: DCREMACCLK lsb: 0  msb: 0 OUTPUT
			this->DCREMACDBUS_A0_B = DCREMACDBUS_A0_B; // net ID: DCREMACDBUS lsb: 0  msb: 0 OUTPUT
			...
			this->DSOCMBRAMABUS_A0_B = DSOCMBRAMABUS_A0_B; // net ID: DSOCMBRAMABUS lsb: 0  msb: 0 OUTPUT
			this->DSOCMBRAMBYTEWRITE_A0_B = DSOCMBRAMBYTEWRITE_A0_B; // net ID: DSOCMBRAMBYTEWRITE lsb: 0  msb: 0 OUTPUT
			this->DSOCMBRAMEN_A0_B = DSOCMBRAMEN_A0_B; // net ID: DSOCMBRAMEN lsb: 0  msb: 0 OUTPUT
			this->DSOCMBRAMWRDBUS_A0_B = DSOCMBRAMWRDBUS_A0_B; // net ID: DSOCMBRAMWRDBUS lsb: 0  msb: 0 OUTPUT
			...
			this->EXTDCRABUS_A0_B = EXTDCRABUS_A0_B; // net ID: EXTDCRABUS lsb: 0  msb: 0 OUTPUT
			this->EXTDCRDBUSOUT_A0_B = EXTDCRDBUSOUT_A0_B; // net ID: EXTDCRDBUSOUT lsb: 0  msb: 0 OUTPUT
			...
			this->ISOCMBRAMRDABUS_A0_B = ISOCMBRAMRDABUS_A0_B; // net ID: ISOCMBRAMRDABUS lsb: 0  msb: 0 OUTPUT
			this->ISOCMBRAMWRABUS_A0_B = ISOCMBRAMWRABUS_A0_B; // net ID: ISOCMBRAMWRABUS lsb: 0  msb: 0 OUTPUT
			this->ISOCMBRAMWRDBUS_A0_B = ISOCMBRAMWRDBUS_A0_B; // net ID: ISOCMBRAMWRDBUS lsb: 0  msb: 0 OUTPUT
