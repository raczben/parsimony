...
#ifndef X_FIFO18_36_H
#define X_FIFO18_36_H
...
namespace CPrimitives {
	...
	class X_FIFO18_36: public Primitive{
		...
		NetFlow* RDCOUNT_A8_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* RDCOUNT_A7_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* RDCOUNT_A6_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* RDCOUNT_A5_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* RDCOUNT_A4_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* RDCOUNT_A3_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* RDCOUNT_A2_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* RDCOUNT_A1_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* RDCOUNT_A0_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* RDERR_A0_B; // net ID: RDERR lsb: 0  msb: 0 OUTPUT
		NetFlow* WRCOUNT_A8_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* WRCOUNT_A7_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* WRCOUNT_A6_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* WRCOUNT_A5_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* WRCOUNT_A4_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* WRCOUNT_A3_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* WRCOUNT_A2_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* WRCOUNT_A1_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
		NetFlow* WRCOUNT_A0_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
		...
		public: X_FIFO18_36(
			...
			this->RDCOUNT_A8_B = RDCOUNT_A8_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
			this->RDCOUNT_A7_B = RDCOUNT_A7_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
			this->RDCOUNT_A6_B = RDCOUNT_A6_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
			this->RDCOUNT_A5_B = RDCOUNT_A5_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
			this->RDCOUNT_A4_B = RDCOUNT_A4_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
			this->RDCOUNT_A3_B = RDCOUNT_A3_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
			this->RDCOUNT_A2_B = RDCOUNT_A2_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
			this->RDCOUNT_A1_B = RDCOUNT_A1_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
			this->RDCOUNT_A0_B = RDCOUNT_A0_B; // net ID: RDCOUNT lsb: 0  msb: 8 OUTPUT
			this->RDERR_A0_B = RDERR_A0_B; // net ID: RDERR lsb: 0  msb: 0 OUTPUT
			this->WRCOUNT_A8_B = WRCOUNT_A8_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
			this->WRCOUNT_A7_B = WRCOUNT_A7_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
			this->WRCOUNT_A6_B = WRCOUNT_A6_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
			this->WRCOUNT_A5_B = WRCOUNT_A5_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
			this->WRCOUNT_A4_B = WRCOUNT_A4_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
			this->WRCOUNT_A3_B = WRCOUNT_A3_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
			this->WRCOUNT_A2_B = WRCOUNT_A2_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
			this->WRCOUNT_A1_B = WRCOUNT_A1_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
			this->WRCOUNT_A0_B = WRCOUNT_A0_B; // net ID: WRCOUNT lsb: 0  msb: 8 OUTPUT
