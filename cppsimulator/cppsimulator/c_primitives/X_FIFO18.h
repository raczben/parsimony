...
namespace CPrimitives {
	...
	class X_FIFO18: public Primitive{
		...
		NetFlow* DOP_A1_B; // net ID: DOP lsb: 0  msb: 1 OUTPUT
		NetFlow* DOP_A0_B; // net ID: DOP lsb: 0  msb: 1 OUTPUT
		...
		public: X_FIFO18(
			...
			this->DOP_A1_B = DOP_A1_B; // net ID: DOP lsb: 0  msb: 1 OUTPUT
			this->DOP_A0_B = DOP_A0_B; // net ID: DOP lsb: 0  msb: 1 OUTPUT
