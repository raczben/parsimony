...
#ifndef X_CLKDLLE_MAXIMUM_PERIOD_CHECK_H
#define X_CLKDLLE_MAXIMUM_PERIOD_CHECK_H
...
namespace CPrimitives {
	...
	class x_clkdlle_maximum_period_check: public Primitive{
		...
		public: x_clkdlle_maximum_period_check(
			const char * name,
			//Verilog Parameters:
...
#endif // X_CLKDLLE_MAXIMUM_PERIOD_CHECK_H
