...
#ifndef X_DCM_ADV_MAXIMUM_PERIOD_CHECK_H
#define X_DCM_ADV_MAXIMUM_PERIOD_CHECK_H
...
namespace CPrimitives {
	...
	class x_dcm_adv_maximum_period_check: public Primitive{
		...
		public: x_dcm_adv_maximum_period_check(
			const char * name,
			//Verilog Parameters:
...
#endif // X_DCM_ADV_MAXIMUM_PERIOD_CHECK_H
