...
namespace CPrimitives {
	...
	class X_IN_FIFO: public Primitive{
		...
		NetFlow* D0; // net ID: D0 lsb: 0  msb: 3 INPUT
		NetFlow* D1; // net ID: D1 lsb: 0  msb: 3 INPUT
		NetFlow* D2; // net ID: D2 lsb: 0  msb: 3 INPUT
		NetFlow* D3; // net ID: D3 lsb: 0  msb: 3 INPUT
		NetFlow* D4; // net ID: D4 lsb: 0  msb: 3 INPUT
		NetFlow* D5; // net ID: D5 lsb: 0  msb: 7 INPUT
		NetFlow* D6; // net ID: D6 lsb: 0  msb: 7 INPUT
		NetFlow* D7; // net ID: D7 lsb: 0  msb: 3 INPUT
		NetFlow* D8; // net ID: D8 lsb: 0  msb: 3 INPUT
		NetFlow* D9; // net ID: D9 lsb: 0  msb: 3 INPUT
		...
		X_IN_FIFO(
			...
			this->D0 = D0; // net ID: D0 lsb: 0  msb: 3 INPUT
			this->D1 = D1; // net ID: D1 lsb: 0  msb: 3 INPUT
			this->D2 = D2; // net ID: D2 lsb: 0  msb: 3 INPUT
			this->D3 = D3; // net ID: D3 lsb: 0  msb: 3 INPUT
			this->D4 = D4; // net ID: D4 lsb: 0  msb: 3 INPUT
			this->D5 = D5; // net ID: D5 lsb: 0  msb: 7 INPUT
			this->D6 = D6; // net ID: D6 lsb: 0  msb: 7 INPUT
			this->D7 = D7; // net ID: D7 lsb: 0  msb: 3 INPUT
			this->D8 = D8; // net ID: D8 lsb: 0  msb: 3 INPUT
			this->D9 = D9; // net ID: D9 lsb: 0  msb: 3 INPUT
