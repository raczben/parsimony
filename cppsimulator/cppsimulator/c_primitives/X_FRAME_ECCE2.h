...
#ifndef X_FRAME_ECCE2_H
#define X_FRAME_ECCE2_H
...
namespace CPrimitives {
	...
	class X_FRAME_ECCE2: public Primitive{
		...
		NetFlow* FAR_A25_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A24_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A23_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A22_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A21_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A20_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A19_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A18_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A17_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A16_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A15_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A14_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A13_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A12_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A11_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A10_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A9_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A8_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A7_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A6_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A5_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A4_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A3_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A2_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A1_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		NetFlow* FAR_A0_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
		...
		public: X_FRAME_ECCE2(
			...
			this->FAR_A25_B = FAR_A25_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A24_B = FAR_A24_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A23_B = FAR_A23_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A22_B = FAR_A22_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A21_B = FAR_A21_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A20_B = FAR_A20_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A19_B = FAR_A19_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A18_B = FAR_A18_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A17_B = FAR_A17_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A16_B = FAR_A16_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A15_B = FAR_A15_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A14_B = FAR_A14_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A13_B = FAR_A13_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A12_B = FAR_A12_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A11_B = FAR_A11_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A10_B = FAR_A10_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A9_B = FAR_A9_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A8_B = FAR_A8_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A7_B = FAR_A7_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A6_B = FAR_A6_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A5_B = FAR_A5_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A4_B = FAR_A4_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A3_B = FAR_A3_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A2_B = FAR_A2_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A1_B = FAR_A1_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
			this->FAR_A0_B = FAR_A0_B; // net ID: FAR lsb: 0  msb: 25 OUTPUT
