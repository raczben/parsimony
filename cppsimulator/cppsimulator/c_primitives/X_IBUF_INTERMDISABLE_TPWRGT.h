...
#ifndef X_IBUF_INTERMDISABLE_TPWRGT_H
#define X_IBUF_INTERMDISABLE_TPWRGT_H
...
namespace CPrimitives {
	...
	class X_IBUF_INTERMDISABLE_TPWRGT: public Primitive{
		...
		public: X_IBUF_INTERMDISABLE_TPWRGT(
			const char * name,
			//Verilog Parameters:
...
#endif // X_IBUF_INTERMDISABLE_TPWRGT_H
