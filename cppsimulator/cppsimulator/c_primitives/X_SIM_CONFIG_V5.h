...
#ifndef X_SIM_CONFIG_V5_H
#define X_SIM_CONFIG_V5_H
...
namespace CPrimitives {
	...
	class X_SIM_CONFIG_V5: public Primitive{
		...
		NetFlow* DCMLOCK_A0_B; // net ID: DCMLOCK lsb: 0  msb: 0 INPUT
		...
		public: X_SIM_CONFIG_V5(
			...
			this->DCMLOCK_A0_B = DCMLOCK_A0_B; // net ID: DCMLOCK lsb: 0  msb: 0 INPUT
