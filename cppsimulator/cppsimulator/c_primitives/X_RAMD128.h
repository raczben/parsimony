...
namespace CPrimitives {
	...
	class X_RAMD128: public Primitive{
		...
		NetFlow* RADR6_A0_B; // net ID: RADR6 lsb: 0  msb: 0 INPUT
		...
		NetFlow* WADR6_A0_B; // net ID: WADR6 lsb: 0  msb: 0 INPUT
		...
		public: X_RAMD128(
			...
			this->RADR6_A0_B = RADR6_A0_B; // net ID: RADR6 lsb: 0  msb: 0 INPUT
			...
			this->WADR6_A0_B = WADR6_A0_B; // net ID: WADR6 lsb: 0  msb: 0 INPUT
