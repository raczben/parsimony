...
namespace CPrimitives {
	...
	class X_ARAMB36_INTERNAL: public Primitive{
		...
		NetFlow* REGCLKA; // net ID: REGCLKA lsb: 0  msb: 0 INPUT
		NetFlow* REGCLKB; // net ID: REGCLKB lsb: 0  msb: 0 INPUT
		...
		X_ARAMB36_INTERNAL(
			...
			this->REGCLKA = REGCLKA; // net ID: REGCLKA lsb: 0  msb: 0 INPUT
			this->REGCLKB = REGCLKB; // net ID: REGCLKB lsb: 0  msb: 0 INPUT
