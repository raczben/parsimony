...
namespace CPrimitives {
	...
	class X_GTXE2_CHANNEL: public Primitive{
		...
		parameter_string_t RX_DFE_KL_CFG2;
		...
		parameter_string_t RX_DFE_XYD_CFG;
		...
		NetFlow* GTXTXN; // net ID: GTXTXN lsb: 0  msb: 0 OUTPUT
		NetFlow* GTXTXP; // net ID: GTXTXP lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* CLKRSVD; // net ID: CLKRSVD lsb: 0  msb: 3 INPUT
		...
		NetFlow* GTXRXN; // net ID: GTXRXN lsb: 0  msb: 0 INPUT
		NetFlow* GTXRXP; // net ID: GTXRXP lsb: 0  msb: 0 INPUT
		...
		NetFlow* PMARSVDIN2; // net ID: PMARSVDIN2 lsb: 0  msb: 4 INPUT
		...
		NetFlow* RXDFEXYDHOLD; // net ID: RXDFEXYDHOLD lsb: 0  msb: 0 INPUT
		NetFlow* RXDFEXYDOVRDEN; // net ID: RXDFEXYDOVRDEN lsb: 0  msb: 0 INPUT
		...
		X_GTXE2_CHANNEL(
			...
			parameter_string_t CPLL_CFG, // Default: 24'hB007D8
			...
			parameter_string_t PMA_RSV, // Default: 32'h00000000
			parameter_string_t PMA_RSV2, // Default: 16'h2050
			parameter_string_t PMA_RSV3, // Default: 2'b00
			parameter_string_t PMA_RSV4, // Default: 32'h00000000
			...
			parameter_string_t RXCDR_CFG, // Default: 72'h0B000023FF20400020
			parameter_string_t RXCDR_FR_RESET_ON_EIDLE, // Default: 1'b0
			parameter_string_t RXCDR_HOLD_DURING_EIDLE, // Default: 1'b0
			parameter_string_t RXCDR_LOCK_CFG, // Default: 6'b010101
			...
			parameter_string_t RXLPM_HF_CFG, // Default: 14'b00000011110000
			parameter_string_t RXLPM_LF_CFG, // Default: 14'b00000011110000
			...
			parameter_string_t RXPH_CFG, // Default: 24'h000000
			...
			parameter_string_t RX_BIAS_CFG, // Default: 12'b000000000000
			...
			parameter_string_t RX_CM_TRIM, // Default: 3'b100
			parameter_string_t RX_DATA_WIDTH, // Default: 20
			parameter_string_t RX_DDI_SEL, // Default: 6'b000000
			parameter_string_t RX_DEBUG_CFG, // Default: 12'b000000000000
			parameter_enum_t RX_DEFER_RESET_BUF_EN, // Default: "TRUE"
			parameter_string_t RX_DFE_GAIN_CFG, // Default: 23'h180E0F
			parameter_string_t RX_DFE_H2_CFG, // Default: 12'b000111100000
			parameter_string_t RX_DFE_H3_CFG, // Default: 12'b000111100000
			parameter_string_t RX_DFE_H4_CFG, // Default: 11'b00011110000
			parameter_string_t RX_DFE_H5_CFG, // Default: 11'b00011110000
			parameter_string_t RX_DFE_KL_CFG, // Default: 13'b0001111110000
			parameter_string_t RX_DFE_KL_CFG2, // Default: 32'h3008E56A
			parameter_string_t RX_DFE_LPM_CFG, // Default: 16'h0904
			parameter_string_t RX_DFE_LPM_HOLD_DURING_EIDLE, // Default: 1'b0
			parameter_string_t RX_DFE_UT_CFG, // Default: 17'b00111111000000000
			parameter_string_t RX_DFE_VP_CFG, // Default: 17'b00011111100000000
			parameter_string_t RX_DFE_XYD_CFG, // Default: 13'b0000000010000
			...
			parameter_string_t TERM_RCAL_CFG, // Default: 5'b10000
			parameter_string_t TERM_RCAL_OVRD, // Default: 1'b0
			...
			parameter_string_t TX_DEEMPH0, // Default: 5'b00000
			parameter_string_t TX_DEEMPH1, // Default: 5'b00000
			...
			this->GTXTXN = GTXTXN; // net ID: GTXTXN lsb: 0  msb: 0 OUTPUT
			this->GTXTXP = GTXTXP; // net ID: GTXTXP lsb: 0  msb: 0 OUTPUT
			...
			this->CLKRSVD = CLKRSVD; // net ID: CLKRSVD lsb: 0  msb: 3 INPUT
			...
			this->GTXRXN = GTXRXN; // net ID: GTXRXN lsb: 0  msb: 0 INPUT
			this->GTXRXP = GTXRXP; // net ID: GTXRXP lsb: 0  msb: 0 INPUT
			...
			this->PMARSVDIN2 = PMARSVDIN2; // net ID: PMARSVDIN2 lsb: 0  msb: 4 INPUT
			...
			this->RXDFEXYDHOLD = RXDFEXYDHOLD; // net ID: RXDFEXYDHOLD lsb: 0  msb: 0 INPUT
			this->RXDFEXYDOVRDEN = RXDFEXYDOVRDEN; // net ID: RXDFEXYDOVRDEN lsb: 0  msb: 0 INPUT
