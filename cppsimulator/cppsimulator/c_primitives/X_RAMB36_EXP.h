...
namespace CPrimitives {
	...
	class X_RAMB36_EXP: public Primitive{
		...
		NetFlow* CASCADEOUTLATA; // net ID: CASCADEOUTLATA lsb: 0  msb: 0 OUTPUT
		NetFlow* CASCADEOUTLATB; // net ID: CASCADEOUTLATB lsb: 0  msb: 0 OUTPUT
		NetFlow* CASCADEOUTREGA; // net ID: CASCADEOUTREGA lsb: 0  msb: 0 OUTPUT
		NetFlow* CASCADEOUTREGB; // net ID: CASCADEOUTREGB lsb: 0  msb: 0 OUTPUT
		...
		NetFlow* ADDRAL; // net ID: ADDRAL lsb: 0  msb: 15 INPUT
		NetFlow* ADDRAU; // net ID: ADDRAU lsb: 0  msb: 14 INPUT
		NetFlow* ADDRBL; // net ID: ADDRBL lsb: 0  msb: 15 INPUT
		NetFlow* ADDRBU; // net ID: ADDRBU lsb: 0  msb: 14 INPUT
		NetFlow* CASCADEINLATA; // net ID: CASCADEINLATA lsb: 0  msb: 0 INPUT
		NetFlow* CASCADEINLATB; // net ID: CASCADEINLATB lsb: 0  msb: 0 INPUT
		NetFlow* CASCADEINREGA; // net ID: CASCADEINREGA lsb: 0  msb: 0 INPUT
		NetFlow* CASCADEINREGB; // net ID: CASCADEINREGB lsb: 0  msb: 0 INPUT
		NetFlow* CLKAL; // net ID: CLKAL lsb: 0  msb: 0 INPUT
		NetFlow* CLKAU; // net ID: CLKAU lsb: 0  msb: 0 INPUT
		NetFlow* CLKBL; // net ID: CLKBL lsb: 0  msb: 0 INPUT
		NetFlow* CLKBU; // net ID: CLKBU lsb: 0  msb: 0 INPUT
		...
		NetFlow* ENAL; // net ID: ENAL lsb: 0  msb: 0 INPUT
		NetFlow* ENAU; // net ID: ENAU lsb: 0  msb: 0 INPUT
		NetFlow* ENBL; // net ID: ENBL lsb: 0  msb: 0 INPUT
		NetFlow* ENBU; // net ID: ENBU lsb: 0  msb: 0 INPUT
		NetFlow* REGCEAL; // net ID: REGCEAL lsb: 0  msb: 0 INPUT
		NetFlow* REGCEAU; // net ID: REGCEAU lsb: 0  msb: 0 INPUT
		NetFlow* REGCEBL; // net ID: REGCEBL lsb: 0  msb: 0 INPUT
		NetFlow* REGCEBU; // net ID: REGCEBU lsb: 0  msb: 0 INPUT
		NetFlow* REGCLKAL; // net ID: REGCLKAL lsb: 0  msb: 0 INPUT
		NetFlow* REGCLKAU; // net ID: REGCLKAU lsb: 0  msb: 0 INPUT
		NetFlow* REGCLKBL; // net ID: REGCLKBL lsb: 0  msb: 0 INPUT
		NetFlow* REGCLKBU; // net ID: REGCLKBU lsb: 0  msb: 0 INPUT
		NetFlow* SSRAL; // net ID: SSRAL lsb: 0  msb: 0 INPUT
		NetFlow* SSRAU; // net ID: SSRAU lsb: 0  msb: 0 INPUT
		NetFlow* SSRBL; // net ID: SSRBL lsb: 0  msb: 0 INPUT
		NetFlow* SSRBU; // net ID: SSRBU lsb: 0  msb: 0 INPUT
		NetFlow* WEAL; // net ID: WEAL lsb: 0  msb: 3 INPUT
		NetFlow* WEAU; // net ID: WEAU lsb: 0  msb: 3 INPUT
		NetFlow* WEBL; // net ID: WEBL lsb: 0  msb: 7 INPUT
		NetFlow* WEBU; // net ID: WEBU lsb: 0  msb: 7 INPUT
		...
		X_RAMB36_EXP(
			...
			//Verilog Ports in definition order:
			this->CASCADEOUTLATA = CASCADEOUTLATA; // net ID: CASCADEOUTLATA lsb: 0  msb: 0 OUTPUT
			this->CASCADEOUTLATB = CASCADEOUTLATB; // net ID: CASCADEOUTLATB lsb: 0  msb: 0 OUTPUT
			this->CASCADEOUTREGA = CASCADEOUTREGA; // net ID: CASCADEOUTREGA lsb: 0  msb: 0 OUTPUT
			this->CASCADEOUTREGB = CASCADEOUTREGB; // net ID: CASCADEOUTREGB lsb: 0  msb: 0 OUTPUT
			...
			this->ADDRAL = ADDRAL; // net ID: ADDRAL lsb: 0  msb: 15 INPUT
			this->ADDRAU = ADDRAU; // net ID: ADDRAU lsb: 0  msb: 14 INPUT
			this->ADDRBL = ADDRBL; // net ID: ADDRBL lsb: 0  msb: 15 INPUT
			this->ADDRBU = ADDRBU; // net ID: ADDRBU lsb: 0  msb: 14 INPUT
			this->CASCADEINLATA = CASCADEINLATA; // net ID: CASCADEINLATA lsb: 0  msb: 0 INPUT
			this->CASCADEINLATB = CASCADEINLATB; // net ID: CASCADEINLATB lsb: 0  msb: 0 INPUT
			this->CASCADEINREGA = CASCADEINREGA; // net ID: CASCADEINREGA lsb: 0  msb: 0 INPUT
			this->CASCADEINREGB = CASCADEINREGB; // net ID: CASCADEINREGB lsb: 0  msb: 0 INPUT
			this->CLKAL = CLKAL; // net ID: CLKAL lsb: 0  msb: 0 INPUT
			this->CLKAU = CLKAU; // net ID: CLKAU lsb: 0  msb: 0 INPUT
			this->CLKBL = CLKBL; // net ID: CLKBL lsb: 0  msb: 0 INPUT
			this->CLKBU = CLKBU; // net ID: CLKBU lsb: 0  msb: 0 INPUT
			...
			this->ENAL = ENAL; // net ID: ENAL lsb: 0  msb: 0 INPUT
			this->ENAU = ENAU; // net ID: ENAU lsb: 0  msb: 0 INPUT
			this->ENBL = ENBL; // net ID: ENBL lsb: 0  msb: 0 INPUT
			this->ENBU = ENBU; // net ID: ENBU lsb: 0  msb: 0 INPUT
			this->REGCEAL = REGCEAL; // net ID: REGCEAL lsb: 0  msb: 0 INPUT
			this->REGCEAU = REGCEAU; // net ID: REGCEAU lsb: 0  msb: 0 INPUT
			this->REGCEBL = REGCEBL; // net ID: REGCEBL lsb: 0  msb: 0 INPUT
			this->REGCEBU = REGCEBU; // net ID: REGCEBU lsb: 0  msb: 0 INPUT
			this->REGCLKAL = REGCLKAL; // net ID: REGCLKAL lsb: 0  msb: 0 INPUT
			this->REGCLKAU = REGCLKAU; // net ID: REGCLKAU lsb: 0  msb: 0 INPUT
			this->REGCLKBL = REGCLKBL; // net ID: REGCLKBL lsb: 0  msb: 0 INPUT
			this->REGCLKBU = REGCLKBU; // net ID: REGCLKBU lsb: 0  msb: 0 INPUT
			this->SSRAL = SSRAL; // net ID: SSRAL lsb: 0  msb: 0 INPUT
			this->SSRAU = SSRAU; // net ID: SSRAU lsb: 0  msb: 0 INPUT
			this->SSRBL = SSRBL; // net ID: SSRBL lsb: 0  msb: 0 INPUT
			this->SSRBU = SSRBU; // net ID: SSRBU lsb: 0  msb: 0 INPUT
			this->WEAL = WEAL; // net ID: WEAL lsb: 0  msb: 3 INPUT
			this->WEAU = WEAU; // net ID: WEAU lsb: 0  msb: 3 INPUT
			this->WEBL = WEBL; // net ID: WEBL lsb: 0  msb: 7 INPUT
			this->WEBU = WEBU; // net ID: WEBU lsb: 0  msb: 7 INPUT
