...
namespace CPrimitives {
	...
	class X_AFIFO36_INTERNAL: public Primitive{
		...
		NetFlow* RDRCLK; // net ID: RDRCLK lsb: 0  msb: 0 INPUT
		...
		X_AFIFO36_INTERNAL(
			...
			parameter_string_t FIFO_SIZE, // Default: 36
			//Verilog Ports in definition order:
			NetFlow* ALMOSTEMPTY, // net ID: ALMOSTEMPTY lsb: 0  msb: 0 OUTPUT
			NetFlow* ALMOSTFULL, // net ID: ALMOSTFULL lsb: 0  msb: 0 OUTPUT
			NetFlow* DBITERR, // net ID: DBITERR lsb: 0  msb: 0 OUTPUT
			...
			this->RDRCLK = RDRCLK; // net ID: RDRCLK lsb: 0  msb: 0 INPUT
