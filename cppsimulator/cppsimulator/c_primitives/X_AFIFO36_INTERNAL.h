...
#ifndef X_AFIFO36_INTERNAL_H
#define X_AFIFO36_INTERNAL_H
...
namespace CPrimitives {
	...
	class X_AFIFO36_INTERNAL: public Primitive{
		...
		NetFlow* RDRCLK_A0_B; // net ID: RDRCLK lsb: 0  msb: 0 INPUT
		...
		public: X_AFIFO36_INTERNAL(
			...
			this->RDRCLK_A0_B = RDRCLK_A0_B; // net ID: RDRCLK lsb: 0  msb: 0 INPUT
