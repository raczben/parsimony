...
namespace CPrimitives {
	...
	class X_ISERDESE2: public Primitive{
		...
		NetFlow* CLKDIVP; // net ID: CLKDIVP lsb: 0  msb: 0 INPUT
		...
		NetFlow* OCLKB; // net ID: OCLKB lsb: 0  msb: 0 INPUT
		...
		X_ISERDESE2(
			...
			this->CLKDIVP = CLKDIVP; // net ID: CLKDIVP lsb: 0  msb: 0 INPUT
			...
			this->OCLKB = OCLKB; // net ID: OCLKB lsb: 0  msb: 0 INPUT
