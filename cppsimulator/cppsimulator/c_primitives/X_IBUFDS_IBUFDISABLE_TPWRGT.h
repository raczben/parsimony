...
#ifndef X_IBUFDS_IBUFDISABLE_TPWRGT_H
#define X_IBUFDS_IBUFDISABLE_TPWRGT_H
...
namespace CPrimitives {
	...
	class X_IBUFDS_IBUFDISABLE_TPWRGT: public Primitive{
		...
		public: X_IBUFDS_IBUFDISABLE_TPWRGT(
			const char * name,
			//Verilog Parameters:
...
#endif // X_IBUFDS_IBUFDISABLE_TPWRGT_H
