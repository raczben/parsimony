...
namespace CPrimitives {
	...
	class X_RAM64M: public Primitive{
		...
		NetFlow* ADDRA; // net ID: ADDRA lsb: 0  msb: 5 INPUT
		NetFlow* ADDRB; // net ID: ADDRB lsb: 0  msb: 5 INPUT
		NetFlow* ADDRC; // net ID: ADDRC lsb: 0  msb: 5 INPUT
		NetFlow* ADDRD; // net ID: ADDRD lsb: 0  msb: 5 INPUT
		NetFlow* DIA; // net ID: DIA lsb: 0  msb: 0 INPUT
		NetFlow* DIB; // net ID: DIB lsb: 0  msb: 0 INPUT
		NetFlow* DIC; // net ID: DIC lsb: 0  msb: 0 INPUT
		NetFlow* DID; // net ID: DID lsb: 0  msb: 0 INPUT
		...
		X_RAM64M(
			...
			this->ADDRA = ADDRA; // net ID: ADDRA lsb: 0  msb: 5 INPUT
			this->ADDRB = ADDRB; // net ID: ADDRB lsb: 0  msb: 5 INPUT
			this->ADDRC = ADDRC; // net ID: ADDRC lsb: 0  msb: 5 INPUT
			this->ADDRD = ADDRD; // net ID: ADDRD lsb: 0  msb: 5 INPUT
			this->DIA = DIA; // net ID: DIA lsb: 0  msb: 0 INPUT
			this->DIB = DIB; // net ID: DIB lsb: 0  msb: 0 INPUT
			this->DIC = DIC; // net ID: DIC lsb: 0  msb: 0 INPUT
			this->DID = DID; // net ID: DID lsb: 0  msb: 0 INPUT
